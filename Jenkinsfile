                ...
                always {
                    script {
                        ...
                        bat """
                            ...
                            set "destination=C:\\Users\\YoanM\\Documents\\Reports\\serenity\\%timestamp%"
                            md "%destination%" 2>nul

                            REM Copiar la carpeta "serenity" al destino
                            set "source=C:\\Jenkins\\workspace\\dxc-automation-mobile-SuperApp-SV\\target\\site\\serenity"
