...
public class FuntionsElementsTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Scroll.to(ID_CARD_ELEMENTS));
        actor.attemptsTo(
                WaitUntil.the(ID_CARD_ELEMENTS, isEnabled()).forNoMoreThan(TIIME_SHORT).seconds(), Click.on(ID_CARD_ELEMENTS)
        );
    }

    public static FuntionsElementsTask chooseElement (){
